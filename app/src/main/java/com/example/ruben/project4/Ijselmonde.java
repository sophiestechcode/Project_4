...
public class Ijselmonde extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ijselmonde);
        ...
        diefstallen.add(new BarEntry(5f, 0));
        diefstallen.add(new BarEntry(7f, 1));
        diefstallen.add(new BarEntry(15f, 2));
        diefstallen.add(new BarEntry(11f, 3));
        diefstallen.add(new BarEntry(36f, 4));
        diefstallen.add(new BarEntry(36f, 5));
        diefstallen.add(new BarEntry(19f, 6));
        diefstallen.add(new BarEntry(16f, 7));
        diefstallen.add(new BarEntry(14f, 8));
        diefstallen.add(new BarEntry(19f, 9));
        diefstallen.add(new BarEntry(14f, 10));
        diefstallen.add(new BarEntry(14f, 11));
