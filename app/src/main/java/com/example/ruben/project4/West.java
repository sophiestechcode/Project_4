...
public class West extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diefstallen.add(new BarEntry(28f, 0));
        diefstallen.add(new BarEntry(23f, 1));
        diefstallen.add(new BarEntry(20f, 2));
        diefstallen.add(new BarEntry(37f, 3));
        diefstallen.add(new BarEntry(45f, 4));
        diefstallen.add(new BarEntry(42f, 5));
        diefstallen.add(new BarEntry(41f, 6));
        diefstallen.add(new BarEntry(52f, 7));
        diefstallen.add(new BarEntry(40f, 8));
        diefstallen.add(new BarEntry(58f, 9));
        diefstallen.add(new BarEntry(53f, 10));
