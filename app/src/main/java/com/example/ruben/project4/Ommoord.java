 ...
 */
public class Ommoord extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ommoord);
        ...
        diefstallen.add(new BarEntry(2f, 0));
        diefstallen.add(new BarEntry(6f, 1));
        diefstallen.add(new BarEntry(3f, 2));
        diefstallen.add(new BarEntry(12f, 3));
        diefstallen.add(new BarEntry(7f, 4));
        diefstallen.add(new BarEntry(12f, 5));
        diefstallen.add(new BarEntry(10f, 6));
        diefstallen.add(new BarEntry(9f, 7));
        diefstallen.add(new BarEntry(7f, 8));
        diefstallen.add(new BarEntry(5f, 9));
        diefstallen.add(new BarEntry(14f, 10));
        diefstallen.add(new BarEntry(11f, 11));
